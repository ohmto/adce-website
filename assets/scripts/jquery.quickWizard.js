(function($) {
    ...
    $.fn.quickWizard = function(options, callback) {
        ...
        var settings = {
            'prevButton': '<button id="form-wizard-prev" class="o-btn o-btn-transparent" type="button">Back</button>',
            'nextButton': '<button id="form-wizard-next" class="o-btn o-btn-medium-red" type="button">Next</button>',
            ...
            'breadCrumbListOpen': '<div class="formsteps">',
            'breadCrumbListClose': '</div>',
            'breadCrumbListClass': 'formsteps',
            'breadCrumbListElementOpen': '<div class="step">',
            'breadCrumbListElementClose': '</div>',
            'breadCrumbActiveClass': 'activestep',
            'breadCrumbCompletedClass': 'completedstep',
        ...
        return this.each(function() {
            ...
            if (settings.breadCrumb) {
                ...
                //     console.log('greater than 3 | ' + breadCrumbList.length );
                // }else{
                //     console.log('less than 3 | ' + breadCrumbList.length );
                // }
            ...
            if (typeof(settings.nextArgs[settings.nextArgs.length - 1]) == "function") {
                ...
                settings.nextArgs[settings.nextArgs.length - 1] = function() { insertedNextCallback.call();
            ...
            $(next).click(function() {
                ...
                if (nextSet.length) {
                    ...
                    active.hide.apply(active, settings.nextArgs);
            ...
            $(prev).click(function() {
                ...
                if (prevSet.length) {
                    ...
                    prevSet.show.apply(prevSet, settings.nextArgs);
                    if (settings.breadCrumb) {
